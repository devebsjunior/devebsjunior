...
### 👨‍💻 Sobre Mim
Meu nome é **Edson Belém de Souza Júnior**. Sou **Full Stack Developer Sênior, Engenheiro de Software e Arquiteto de Inovação**. Sou autodidata, movido por desafios complexos e focado na construção de sistemas distribuídos de alta performance, escalabilidade e resiliência. 

Possuo sólida experiência no desenho e implementação de arquiteturas corporativas robustas e na liderança técnica de soluções de software de ponta a ponta.

* 🎯 **Abordagem Técnica:** Clean Code, SOLID, TDD, DDD e padrões de microsserviços.
* ☁️ **Cloud & Infra:** Ampla vivência em ambientes AWS, Azure, GCP, SaaS, PaaS e IaaS.
...
<p align="left">
  <img src="https://img.shields.io/badge/Java_21%2F17-ED8B00?style=for-the-badge&logo=openjdk&logoColor=white" alt="Java"/>
...
#### **Frameworks & Ecossistemas (Backend & Frontend)**
<p align="left">
...
#### **Padrões de Arquitetura & Mensageria**
<p align="left">
  <img src="https://img.shields.io/badge/Hexagonal_Architecture-85EA2D?style=for-the-badge" alt="Hexagonal"/>
  <img src="https://img.shields.io/badge/CQRS-0052CC?style=for-the-badge" alt="CQRS"/>
  <img src="https://img.shields.io/badge/SOA-FF6C37?style=for-the-badge" alt="SOA"/>
...
* **Java/Backend:** JUnit, Mockito, Cucumber, Spock Framework, JMeter, k6.
* **API & Eventos:** Postman, Insomnia, SuperTest.
* **E2E / Interface:** Selenium, Cypress, Mocha, Chai.
...
* 🚀 **Metodologias Ágeis & Processos:**
  * Scrum Fundamentals Certified (SFC)
  * Certified Associate In Scrum Fundamentals™ (CASF™)
* 🛡️ **Segurança & Gestão de Qualidade:**
...
| Métrica | Especialidade | Nível de Atuação |
| :--- | :--- | :--- |
| 🏗️ **Arquitetura** | Microsserviços, Event-Driven, Hexagonal | Sênior / Especialista |
| 🛡️ **Qualidade & ISO** | Testes Automatizados, Carga, ISO 27001/9001 | Auditor / Líder Técnico |
| 🚀 **Ecossistema** | Java (Virtual Threads), .NET, TypeScript | Full Stack Backend Core |
| ☁️ **Ambientes** | AWS, Azure, Google Cloud Platform (GCP) | Cloud Native DevOps |

---

### 💌 Por aqui você pode entrar em contato comigo: ⤵️
Para parcerias de arquitetura, consultorias em sistemas legados, migrações para microsserviços ou automação de testes corporativos:

[![Gmail](https://img.shields.io/badge/-Gmail-FF0000?style=flat-square&labelColor=FF0000&logo=gmail&logoColor=white)](mailto:devebsjunior@gmail.com)
[![Linkedin](https://img.shields.io/badge/-Linkedin-0e76a8?style=flat-square&logo=Linkedin&logoColor=white)](https://www.linkedin.com/in/edsonbelemsjunior/)
[![WhatsApp](https://img.shields.io/badge/-WhatsApp-25d366?style=flat-square&labelColor=25d366&logo=whatsapp&logoColor=white)](https://wa.me/5521981990108)
